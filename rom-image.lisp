...
FB0    9 BD  1 A3  C C6  0 D5   F8 40 B3 F8  0 A3 43 FB
FC0   40 3A CE 43 FB  2 3A CE    3 FB C0 3A CE D3 F8 46
...
(length
 (setq *gll-rom-image*
       (progn
         (iterate loop ( (image (cdr *gll-rom-image*)) )
           (when image
             (setf (nthcdr 16 image) (nthcdr 17 image))
             (loop (nthcdr 16 image))))
         (cdr *gll-rom-image*))))
